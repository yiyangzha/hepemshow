...
#ifndef EVENTLOOPSPHERE_HH
#define EVENTLOOPSPHERE_HH
...
public:
   ...
   */
  static void ProcessEvents(G4HepEmTLData& theTLData, G4HepEmState& theState, PrimaryGenerator& thePrimaryGenerator, GeometrySphere& theGeometrySphere, Results& theResult, int numEventToSimulate, int verbosity);

private:
  EventLoopSphere() = delete;

  /** Method invoked at the beginning of each event by passing the (single) primary track of the event.*/
  static void BeginOfEventAction(Results& theResult, int eventID, const G4HepEmTrack& thePrimaryTrack, GeometrySphere& theGeometrySphere, PrimaryGenerator& thePrimaryGenerator);
